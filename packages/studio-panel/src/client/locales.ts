...
export const zh: Record<StudioPanelKey, string> = {
  ...
  'creation.notes.saved': '批注已保存。正文对应句子有颜色标记；上方「作者选区批注」可定位，右侧「修订」里可标为已解决。',
...
export const en: Record<StudioPanelKey, string> = {
  ...
  'creation.notes.saved': 'The note was saved. The quoted sentence is marked in the body; use the notes bar above the editor to locate it, or Revisions to resolve it.',
