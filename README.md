...
| 路径 | 说明 |
|---|---|
| `packages/openwrite-bridge/` | dsh 插件：15 个 `novel_*` 工具，经 Studio HTTP 动作面调用 OpenWrite |
...
**Dante 写作** 预设；稿件编辑在 Studio（http://127.0.0.1:4567）进行。
...
桥接插件与预设代码沿用 OpenWrite 的 Apache-2.0；`skills/` 下 oh-story-*
