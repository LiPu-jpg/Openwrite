...
**0.2.7 标准插件包**兼容 dsh **0.1.2-rc.1**。可下载版本、三平台验收结果和 SHA-256 以 [GitHub Release](https://github.com/LiPu-jpg/Openwrite/releases/tag/v0.2.7) 附件为准；验收方法见 [发布验收](docs/RELEASE_ACCEPTANCE.md)。不追随 dsh `alpha`。
